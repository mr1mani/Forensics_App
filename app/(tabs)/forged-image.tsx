...
export default function EditedImageScreen() {
  ...
  const processImage = async () => {
    ...
    try {
      ...
      // Changed endpoint to /api/process/edited-image
      const response = await fetch(`${serverUrl}/api/process/forged-image`, {
        method: "POST",
        headers: {
      ...
      try {
        ...
        Alert.alert('Analysis Complete', 'Image forgery analysis saved to reports!');
      } catch (storageError) {
  ...
  return (
    ...
    >
      ...
      <Text style={[styles.subtitle, { color: colors.placeholder }]}>
        Select an image to analyze for editing, photoshop, or forgery
      </Text>
          ...
          >
            {isProcessing ? (
              ...
              <View style={styles.buttonContent}>
                ...
                <Text style={styles.buttonText}>Detect Forgery</Text>
              </View>
            )}
          </TouchableOpacity>
        </View>
